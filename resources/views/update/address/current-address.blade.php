                                    ...
                                    <div class="collapsible-header" id="current-address">
                                        <div class="custom-collapsible-header-inner">
                                            <div class="fl disable-bubble">
                                                <input type="checkbox" class="shareCheckbox" id="currentAddressData" name="currentAddressData" @if($resumeAccess && $resumeAccess->currentAddressData=='1') value="1" checked="checked" @else value="0" @endif  />
