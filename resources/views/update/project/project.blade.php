                                <li>
                                    <div class="collapsible-header" id="projectInfo">
                                        <div class="custom-collapsible-header-inner">
                                            ...
                                            <div class="fl">
                                                Key assignments / Projects @if($projectCount > 0) ({{$projectCount}}) @endif
                                            </div>
                                                    ...
                                                    <div class = "switch">
                                                        <label>
                                                            @if($projectCount > 0 && $projectInfo[0]['private'])
                                                                <input type="checkbox" class="PPCheck" data-id="project" checked>
                                                            @else
                                                                <input type="checkbox" class="PPCheck" data-id="project">
                                                            @endif
