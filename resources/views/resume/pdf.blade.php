								...
								<div class="inner-wrapper resume-inner-wrapper">
									<div class="user-profile">
                                        ...
                                        <div class="display-flex align-items-center sm-display-block">
                                            ...
                                            <span class="dot-separator t4"></span>
                                        ...
                                        <div class="display-flex align-items-center sm-display-block">
                                            <span class="phone">
                                                    <a href="tel:+{{$contactInfo->primaryPhoneCode}}{{$contactInfo->primaryPhone}}">+{{$contactInfo->primaryPhoneCode}}-{{$contactInfo->primaryPhone}}</a></span>
                                            <span class="email">
                                                <span class="dot-separator t1"></span>
                                                <a href="mailto:{{$contactInfo->altEmail!="" ? trim($contactInfo->altEmail): trim($profileData->email)}}"><?php echo $contactInfo->altEmail!="" ? trim($contactInfo->altEmail): trim($profileData->email);?></a>
                                            </span>
									...
									<div class="block">
										...
										<div class="exp-details">
											...
											<div class="col2">
                                                <strong class="black-text text-lighten-3">{{$work->designation}}
                                                    <span class="dot-separator t4"></span>
												...
												<p>
                                                    ...
                                                    <span class="dot-separator t4"></span>{{$work->country}}
												</p>
                                                <p>
